...
export const REPORTS_DATA: Record<string, Record<Lang, ReportDetail>> = {
  akira: {
    pt: {
      id: "CMDB-TR-006",
      title:
        "Análise dinâmica comparativa e verificação de recuperação do Akira Ransomware em ambiente isolado (Windows 7 SP1)",
      familyKey: "akira",
      meta: [
        ...
        {
          label: "AUTOR",
          value: "Comunidade de Segurança Ofensiva · CIn-UFPE",
        },
        { label: "CLASSIFICAÇÃO", value: "Pesquisa Acadêmica Defensiva" },
        {
          label: "SITUAÇÃO EDITORIAL",
          value: "Publicado (Revisado por Pares)",
        },
      ],
      toc: [
        { n: "01", label: "Resumo e escopo do estudo" },
        ...
        {
          n: "07",
          label: "Referências e indicadores de comprometimento (IoCs)",
        },
      ],
      sections: [
        {
          id: "s1",
          n: "01",
          title: "Resumo e escopo do estudo",
    ...
    en: {
      id: "CMDB-TR-006",
      title:
        "Comparative dynamic analysis and recovery verification of Akira Ransomware in isolated environment (Windows 7 SP1)",
      familyKey: "akira",
      meta: [
      ...
      toc: [
        { n: "01", label: "Summary and study scope" },
